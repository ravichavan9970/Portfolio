          ...
          >
            <div className="space-y-8 text-left">
              ...
              <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-start gap-3.5 shadow-sm">
                ...
                <div>
                  <h4 className="text-xs font-bold text-emerald-400 font-display">Career Availability Status</h4>
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, idx) => (
                    <a
                      ...
                      className="flex gap-4 p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/15 hover:bg-white/[0.04] transition-all group"
                    >
                      <div className="p-2.5 rounded-lg bg-white/[0.05] border border-white/10 shrink-0 shadow-sm">
                        {info.icon}
                      </div>
                      <div className="min-w-0">
                        <span className="text-[9px] font-bold text-text-muted font-mono uppercase block">{info.label}</span>
                        <span className="text-xs font-bold text-text-title truncate block mt-0.5 group-hover:text-primary transition-colors">{info.value}</span>
                      </div>
                    </a>
                  ))}
                </div>
            ...
            <div className="pt-8 border-t border-white/10 text-left">
              <span className="text-[9px] font-bold text-text-muted font-mono uppercase block mb-3">Social Profiles</span>
              <div className="flex items-center gap-2.5">
                <a
                  href="https://github.com/ravichavan9970"
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-xl bg-white/[0.03] hover:bg-white/10 border border-white/10 hover:border-primary/30 text-text-muted hover:text-white transition-all duration-300"
                  title="GitHub"
                >
                  <FaGithub size={16} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-xl bg-white/[0.03] hover:bg-white/10 border border-white/10 hover:border-primary/30 text-text-muted hover:text-[#3B82F6] transition-all duration-300"
                  title="LinkedIn"
                >
                  <FaLinkedin size={16} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-xl bg-white/[0.03] hover:bg-white/10 border border-white/10 hover:border-primary/30 text-text-muted hover:text-[#EC4899] transition-all duration-300"
                  title="Instagram"
                >
                  <FaInstagram size={16} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-xl bg-white/[0.03] hover:bg-white/10 border border-white/10 hover:border-primary/30 text-text-muted hover:text-emerald-400 transition-all duration-300"
                  title="WhatsApp"
                >
                  <FaWhatsapp size={16} />
                </a>
          ...
          >
            {status === 'success' ? (
              ...
              >
                ...
                <p className="text-xs text-text-muted max-w-sm leading-relaxed font-semibold">
              ...
              <form onSubmit={(e) => handleSubmit(e, 'email')} className="space-y-6 text-left">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="name" className="text-[10px] font-semibold text-text-muted uppercase tracking-[0.08em] font-mono">Full Name</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="email" className="text-[10px] font-semibold text-text-muted uppercase tracking-[0.08em] font-mono">Email Address</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="message" className="text-[10px] font-semibold text-text-muted uppercase tracking-[0.08em] font-mono">Your Message</label>
                  <textarea
                    id="message"
                    name="message"
